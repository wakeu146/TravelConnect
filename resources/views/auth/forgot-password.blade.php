<x-auth-layout title="Reset password | TravelConnect">
    <main class="grid min-h-screen lg:grid-cols-2">
        <section class="relative hidden overflow-hidden bg-[#173042] lg:block">
            ...
            <div class="relative flex h-full flex-col justify-between p-12 text-white xl:p-16">
                ...
                <div class="max-w-sm">
                    <p class="text-xs font-bold uppercase tracking-[.2em] text-[#f6c9bb]">Account recovery</p>
                    <h1 class="mt-5 font-serif text-5xl leading-tight">Let’s get your agency back on track.</h1>
                    <p class="mt-6 text-base leading-7 text-white/70">Reset your access securely and return to managing your agency workspace.</p>
                </div>
                <p class="text-sm text-white/50">We’ll help you get back on the road.</p>
            </div>
        </section>
        ...
        <section class="flex min-h-screen items-center justify-center px-6 py-12 sm:px-10">
            <div class="w-full max-w-md">
                ...
                <div class="border-b border-[#dbe3e5] pb-7">
                    ...
                    <h1 class="mt-3 font-serif text-4xl leading-tight tracking-tight">Reset your password</h1>
                    <p class="mt-4 text-sm leading-6 text-[#607985]">Enter your email address and we’ll send you a secure six-digit verification code.</p>
                </div>
                ...
                <form action="{{ route('password.email') }}" method="POST" class="mt-8 grid gap-5">
                    ...
                    <button type="submit" data-loading-submit class="flex items-center justify-center gap-2 rounded-xl bg-[#e76f51] px-5 py-3.5 text-sm font-bold text-white shadow-sm transition hover:bg-[#d95f42]">
                        <span data-submit-label>Send verification code</span>
                ...
                <a href="{{ route('login') }}" class="mt-6 flex items-center justify-center gap-2 text-sm font-semibold text-[#607985] transition hover:text-[#173042]">
